...
# Model: RandomForest
# Recommendations applied: ['Perform a more thorough hyperparameter tuning process to optimize the ROC-AUC score and improve overall model performance.', 'Consider incorporating additional features or preprocessing techniques to reduce the correlation between accuracy and f1 scores.']
...
learner_genes = ['PALB2', 'CDH1', 'TP53', 'MDC1', 'ESR1', 'EGFR', 'RAD50', 'HIF1A', 'SFN', 'PTEN', 'EP300', 'RAD51', 'PGR', 'HSP90AA1', 'BRCA1', 'PIK3CA', 'ERBB2', 'HDAC1', 'ATM', 'CHEK2']
